...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/C0y53M3k6cW7KvjUhQqJXE?mode=ac_t',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://files.catbox.moe/letrek.jpg',
    NEWSLETTER_JID: '120363195131426892@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94742890037',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029Va8Yh2jJpe8bn5Tayl1Y'
};
...
const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃';
const footerText = '𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃';
...
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        viewOnce: true,
        image: { url: "https://files.catbox.moe/letrek.jpg" },
        caption: `𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 𝐀𝙻𝙸𝚅𝙴 𝐍𝙾𝚆\n\n${captionText}`,
    }, { quoted: msg });
    break;
       }
...
`;
    ...
    await socket.sendMessage(from, {
        image: { url: config.RCD_IMAGE_PATH },
        caption: `✨ *Welcome to 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 MINI BOT* ✨\n\n${menuText}\n\n> 🚀 Powered by 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃`
    });
...
FN:𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 Owner
ORG:𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃
TEL;type=CELL;type=VOICE;waid=94742890037:+94 75 326 2213
END:VCARD`;
    ...
    try {
        ...
        if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_STATUS_SEEN) {
            ...
            if (config.AUTO_STATUS_REPLY) {
                const customMessage = config.STATUS_READ_MSG || '*✅ Auto Status Seen Bot By 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃*';
...
case 'chalah': {
    try {
        ...
        let txt = `*👑 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 DEPLOYERS LIST*\n\n`;
        let count = 1;
        ...
        console.error("❌ 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 plugin error:", err);
    ...
    try {
        ...
        const cards = await Promise.all(selected.map(async (vid) => {
            ...
            return {
                ...
                footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 𝐅𝚁𝙴𝙴 𝐁𝙾𝚃" }),
            ...
            viewOnceMessage: {
                message: {
                    ...
                    interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                        ...
                        footer: { text: "> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃" },
                ...
                case 'winfo':
                    ...
                    if (inputNumber.length < 10) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Invalid phone number!(පකයට බුලත් දෙන්න බැ +94 ගහපම්)(e.g., +94742890037)',
                                '> 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃'
                            )
                        });
                        break;
    ...
    try {
        ...
        if (data && data.length > 0) {
            ...
            await socket.sendMessage(sender, {
                video: { url: videoUrl },
                mimetype: 'video/mp4',
                caption: '> 𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃  𝐌 𝐃'
            }, { quoted: msg });
...
case 'ping': {
  ...
  if (!q || q.trim() === '') {
    return await socket.sendMessage(sender, {
      text: "ඕ කියන්න අනේ් මම 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 AI🤭"
    }, { quoted: msg });
  }

  const prompt = `ඔබගේ නම 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 𝐀𝐈.  
...
"කව්ද ඔයා" කියනවා නම්:  
👉 "මම 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 AI… 🤤" කියන්න.

"ඔයාව හැදුවේ කවුද" කියනවා නම්:  
👉 "මාව හැදුවෙ 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃 MD  😘" කියන්න.
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 𝐃𝐀𝐑𝐊 𝐗 𝐌𝐃  𝐅𝚁𝙴𝙴 𝐁𝙾𝚃 වැඩ හුත්තො',
